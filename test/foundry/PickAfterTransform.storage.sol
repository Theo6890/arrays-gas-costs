...
contract PickAfterTransformTest is Test {
    ...
    /*//////////////////////////////////////////////////////////////
                                 YUL
    //////////////////////////////////////////////////////////////*/
    function test_pickAfterTransform_result_to_storage_Yul_50_000() public {
        instance.setTransformedRands(randoms_27_000);

        address[] memory result = instance
            .YUL_pickAfterTransform_result_to_storage(
                addresses_50_000,
                27_000
            );
    ...
    function test_pickAfterTransform_result_to_storage_Yul_40_000() public {
    ...
    function test_pickAfterTransform_result_to_storage_Yul_35_000() public {
    ...
    function test_pickAfterTransform_result_to_storage_Yul_30_000() public {
    ...
    function test_pickAfterTransform_result_to_storage_Yul_20_000() public {
        instance.setTransformedRands(randoms_5_000);

        address[] memory result = instance
            .YUL_pickAfterTransform_result_to_storage(addresses_20_000, 5_000);
        assertEq(result.length, 5_000);
    }

    function test_pickAfterTransform_result_to_storage_Yul_10_000() public {
        instance.setTransformedRands(randoms_2_300);

        address[] memory result = instance
            .YUL_pickAfterTransform_result_to_storage(addresses_10_000, 2_300);
        assertEq(result.length, 2_300);
    }

    function test_pickAfterTransform_result_to_storage_Yul_5_000() public {
        instance.setTransformedRands(randoms_834);

        address[] memory result = instance
            .YUL_pickAfterTransform_result_to_storage(addresses_5_000, 834);
        assertEq(result.length, 834);
    }

    function test_pickAfterTransform_result_to_storage_Yul_1_000() public {
        instance.setTransformedRands(randoms_124);

        address[] memory result = instance
            .YUL_pickAfterTransform_result_to_storage(addresses_1_000, 124);
        assertEq(result.length, 124);
    }

    function test_pickAfterTransform_result_to_storage_Yul_500() public {
        instance.setTransformedRands(randoms_75);

        address[] memory result = instance
            .YUL_pickAfterTransform_result_to_storage(addresses_500, 75);
