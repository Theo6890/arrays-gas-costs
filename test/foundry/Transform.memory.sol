...
contract TransformTest is Test {
    ...
    function test_transformRandomsToMatchRange_result_to_memory_45_000()
        public
    {
        instance.transformRandoms_result_to_memory(45_000);
    }
    ...
    function test_transformRandomsToMatchRange_result_to_memory_Yul_45_000()
        public
    {
        instance.YUL_transformRandoms_result_to_memory(45_000);
    }
