...
contract TransformAndPickAddressTest is Test {
    ...
    function test_transformAndPick_result_to_storage_Yul_50_000() public {
        ...
        address[] memory result = instance
            .YUL_transformAndPick_result_to_storage(addresses_50_000, 27_000);
        assertEq(result.length, 27_000);
    }

    function test_transformAndPick_result_to_storage_Yul_40_000() public {
        instance.setRandoms(randoms_22_000);

        address[] memory result = instance
            .YUL_transformAndPick_result_to_storage(addresses_40_000, 22_000);
        assertEq(result.length, 22_000);
    }

    function test_transformAndPick_result_to_storage_Yul_35_000() public {
        instance.setRandoms(randoms_19_000);

        address[] memory result = instance
            .YUL_transformAndPick_result_to_storage(addresses_35_000, 19_000);
    ...
    function test_transformAndPick_result_to_storage_Yul_30_000() public {
        ...
        address[] memory result = instance
            .YUL_transformAndPick_result_to_storage(addresses_30_000, 11_000);
    ...
    function test_transformAndPick_result_to_storage_Yul_20_000() public {
        ...
        address[] memory result = instance
            .YUL_transformAndPick_result_to_storage(addresses_20_000, 5_000);
    ...
    function test_transformAndPick_result_to_storage_Yul_10_000() public {
        ...
        address[] memory result = instance
            .YUL_transformAndPick_result_to_storage(addresses_10_000, 2_300);
    ...
    function test_transformAndPick_result_to_storage_Yul_5_000() public {
        ...
        address[] memory result = instance
            .YUL_transformAndPick_result_to_storage(addresses_5_000, 834);
    ...
    function test_transformAndPick_result_to_storage_Yul_1_000() public {
        ...
        address[] memory result = instance
            .YUL_transformAndPick_result_to_storage(addresses_1_000, 124);
    ...
    function test_transformAndPick_result_to_storage_Yul_500() public {
        ...
        address[] memory result = instance
            .YUL_transformAndPick_result_to_storage(addresses_500, 75);
